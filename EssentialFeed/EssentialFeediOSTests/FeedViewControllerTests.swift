...
final class FeedViewControllerTests: XCTestCase {
	...
	func test_loadFeedActions_requestFeedFromLoader() {
		...
		XCTAssertEqual(loader.loadCallCount, 0, "Exptected no loading requests before view is loaded")
		...
		sut.simulateUserInitiatedFeedReload()
		XCTAssertEqual(loader.loadCallCount, 3, "Exptected a third loading request once user initiates another load")
	}
